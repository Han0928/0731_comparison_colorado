# 22Mar, added (nuc/ccn)_mean; commented 'print'
...
def load_model(timeindexes,path,varlist,date,is_lam,is_dump):
    ...
    if 'N_All'in varlist or 'N_Nuc'in varlist or 'N_Ait_In' in varlist or 'N_Ait' in varlist or 'N_Acu' in varlist or 'N_Cor' in varlist \
        ...
        #To calculate the nucleation/CCN contribution 
...
def read_flight_data(date):
    ...
    nh3_path = '/jet/home/ding0928/Colorado/Colorado/FRAPPE-NH3_C130_20140731_R0.ict'
    ...
    d= {'time':pd.Series(trackpdtime), 'latitude':pd.Series(np.asarray(lat)),
        ...
        'OH':pd.Series(ohtrack),'H2SO4':pd.Series(h2so4track),
...
#path_glm = '/jet/home/ding0928/cylc-run/u-cs093/share/cycle/20140730T0000Z/glm/um/'
path_glm = '/jet/home/ding0928/cylc-run/u-ct706/share/cycle/20140730T0000Z/glm/um/'
...
if date=='20140731':
    timeindexes_glm=['042','045','048','051']  #0730+24h+18h=0731_18pm
    timeindexes_lam=['042','048'] #0730+24h+12h=0731_12pm
    lonmin=-112
...
if make_dataset==1:
    ...
    df.to_csv('interpolated_0731_c130_'+date+'.csv')
else:
    df = pd.read_csv('interpolated_0731_c130_'+date+'.csv',index_col=0, parse_dates=True)
    print(df.head())
    conc_dict = load_model(timeindexes_lam, path_model,varlist,date,1,0)
...
if 'SUMNC2' in varlist:
    norm_array_sumnc2 = [0,0.00001,0.0001,0.001,0.005,0.008,0.01,0.03,0.04]
