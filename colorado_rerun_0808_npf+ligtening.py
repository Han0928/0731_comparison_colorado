...
from obser_for_Merge_0808_altagl import merge_obs_method
...
def read_flight_data(date):
    flight_path='/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140808_r0.ict'

    tracktime,alt,lat,lon = read_flight_track(flight_path,73, 4,2,3) # .checked 0808
    ...
    c5h8_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-PTRTOF-NMHCs_P3B_20140808_R0.ict'
    ...
    no_o3_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-NOXYO3_P3B_20140808_R0.ict'
    ...
    co_p3b_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-DACOM_P3B_20140808_R0.ict'
    ...
    n_nuc_p3b_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-CNC_P3B_20140808_R0.ict'
...
if date=='20140808':
    ...
    timeindexes_lam=['036','042','048'] #0807+12h=0806_12pm
    lonmin=-112
...
if make_dataset==1:
    ...
    df.to_csv('interpolated_0808_lighenting_'+date+'.csv')
else:
    df = pd.read_csv('interpolated_0808_lighenting_'+date+'.csv',index_col=0, parse_dates=True)
    # print df.head()
    conc_dict = load_model(timeindexes_lam, path_model,varlist,date,1,0)
