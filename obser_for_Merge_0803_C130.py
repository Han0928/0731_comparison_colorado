...
def merge_obs_method():
    ...
    file_100 = Dataset(
        '/jet/home/ding0928/Colorado/EOLdata/dataaw2NKX/RF07Z.20140803.202700_010000.PNI.nc')  #
    print('file_100', file_100)
    temp = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140803_R4.ict', delimiter=',',
                      skiprows=133, usecols=29)  # inC
    pres = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140803_R4.ict', delimiter=',',
                      skiprows=133, usecols=62)  # in hpa
    print('temp.shape', temp.shape)  # 16380,
    ...
    time_NAV = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140803_R4.ict',
                          delimiter=',',
    ...
    print('data_100.shape', data_100.shape)  # (16381, 31)
    ...
    # # since for 0803 C130, all smps data is missing, thus I deleted this session
    # c = range(20, 34)  # column in smpsc=15*1
    # data_smps = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/frappe-SMPS_C130_20140803_R0.ict', delimiter=',',
    #                        skiprows=66, usecols=c)  # from col 18-33
    # data_smps = ma.masked_where(data_smps < 0, data_smps)
    # smps_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/frappe-SMPS_C130_20140803_R0.ict', delimiter=',',
    #                        skiprows=66, usecols=0)  #
    #
    # print('data_smps_shape', data_smps.shape)  # (226, 14)
