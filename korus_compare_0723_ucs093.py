...
path_model='/jet/home/ding0928/cylc-run/u-cs093/share/cycle/20140722T0000Z/Regn1/resn_1/RA2M/um/'
path_glm = '/jet/home/ding0928/cylc-run/u-cs093/share/cycle/20140722T0000Z/glm/um/'
...
if make_dataset==1:
    ...
    df.to_csv(path+'0723_093_dataset_'+date+'.csv')
    df_smps.to_csv(path+'0723_093_smps_dataset_'+date+'.csv')
    
    sys.exit()
else:
    df = pd.read_csv(path+'0723_093_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    if two_models==1:
        df2 = pd.read_csv(path+'0723_093_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    else:
        df2=None
    # print df.head()
    if date=='20160510':
...
df_smps = pd.read_csv(path+'0723_093_smps_dataset_'+date+'.csv',index_col=0, parse_dates=True)
print(df_smps)
plt.figure()
...
plot_sizedistribution(df_smps_1,'0723_093_L08:40-09:0.png')
df_smps_2 = df_smps.between_time(start_time='16:00', end_time='16:10').mean() #L
plot_sizedistribution(df_smps_2,'0723_093_L10:00-10:10.png')
df_smps_3 = df_smps.between_time(start_time='16:50', end_time='17:00').mean() #L
plot_sizedistribution(df_smps_3,'0723_093_L10:50-11:00.png')
