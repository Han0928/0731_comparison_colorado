...
from obser_for_Merge_0727_altagl import merge_obs_method
...
def read_flight_data(date):
    flight_path='/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140727_r0.ict'

    tracktime,alt,lat,lon = read_flight_track(flight_path,73, 4,2,3) # 0727
    ...
    c5h8_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-PTRTOF-NMHCs_P3B_20140727_R0.ict'
    c5h8time, c5h8, c10h16, nh3 = read_flight_track(c5h8_path, 67, 17, 31, 3) #checked 0727
    ...
    no_o3_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-NOXYO3_P3B_20140727_R0.ict'
    notime, no, no2, o3 = read_flight_track(no_o3_path, 47, 3, 5, 6) #checked 0727
    ...
    co_p3b_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-DACOM_P3B_20140727_R1_L1.ict'
    ...
    n_nuc_p3b_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-CNC_P3B_20140727_R0.ict'
    ...
    date = '20140727' # even though you passed in date(0726),but redefined here.
...
# def colorado_mod_J():
date= '20140726'
varlist = ['N_Nuc','N_10','N_All','NH3','P','T']
...
if date=='20140726':
    timeindexes_glm=['042','045','048']  #0726+24h+18h=0727_18pm UTC
...
if make_dataset==1:
    ...
    df.to_csv('interpolated_0727_lighenting_'+date+'.csv')
else:
    df = pd.read_csv('interpolated_0727_lighenting_'+date+'.csv',index_col=0, parse_dates=True)
    # print df.head()
    conc_dict = load_model(timeindexes_lam, path_model,varlist,date,1,0)
...
if 'SO2' in varlist:
    ...
    plot_comparison(df,df['SO2'],df['model_SO2'],df['glm_SO2'],(conc_dict['SO2'])[1,3,:,:],(conc_dict_glm['SO2'])[1,3,:,:],
...
if 'OH' in varlist:
    ...
    plot_comparison(df,df['OH'],df['model_OH'],df['glm_OH'],(conc_dict['OH'])[1,3,:,:],(conc_dict_glm['OH'])[1,3,:,:],
...
if 'T' in varlist:
    ...
    if is_dump:
        ...
        plot_comparison(df,df['T'],df['model_T'],df['glm_T'],(conc_dict['T'])[1,3,:,:],(conc_dict_glm['T'])[1,3,:,:],
                        'T (K)', 260,310,280,310,False,norm_array_temp,'korus_T_'+date+'ion_npf_cs093.png', date)
...
if 'H2SO4' in varlist:
    ...
    plot_comparison(df,df['H2SO4'],df['model_H2SO4'],df['glm_H2SO4'],(conc_dict['H2SO4'])[1,3,:,:],(conc_dict_glm['H2SO4'])[1,3,:,:],
...
if 'NH3' in varlist:
    ...
    plot_comparison(df,df['NH3'],df['model_NH3'],df['glm_NH3'],(conc_dict['NH3'])[1,3,:,:],(conc_dict_glm['NH3'])[1,3,:,:],
...
if 'C5H8' in varlist:
    ...
    plot_comparison(df,df['C5H8'],df['model_C5H8'],df['glm_C5H8'],(conc_dict['C5H8'])[1,3,:,:],(conc_dict_glm['C5H8'])[1,3,:,:],
...
if 'NO' in varlist:
    ...
    plot_comparison(df,df['NO'],df['model_NO'],df['glm_NO'],(conc_dict['NO'])[1,3,:,:],(conc_dict_glm['NO'])[1,3,:,:],
...
if 'O3' in varlist:
    ...
    plot_comparison(df,df['O3'],df['model_O3'],df['glm_O3'],(conc_dict['O3'])[1,3,:,:],(conc_dict_glm['O3'])[1,3,:,:],'O3 (ppbv)', 30,90,30,90,False,norm_array_o3,'korus_O3_'+date+'ion_npf_cs093.png', date)
...
#     plot_comparison(df,df['CO'],df['model_CO'],df['glm_CO'],(conc_dict['CO'])[1,3,:,:],(conc_dict_glm['CO'])[1,3,:,:],
...
if 'P' in varlist:
    ...
    plot_comparison(df,df['P'],df['model_P'],df['glm_P'],(conc_dict['P'])[1,3,:,:],(conc_dict_glm['P'])[1,3,:,:],
...
if 'SUMNC2' in varlist:
    ...
    plot_comparison(df,df['SUMNC2'],df['model_SUMNC2'],df['glm_SUMNC2'],(conc_dict['SUMNC2'])[1,3,:,:],(conc_dict_glm['SUMNC2'])[1,3,:,:],
...
if 'N_Nuc' in varlist:
    ...
    plot_comparison(df,df['N_Nuc'],df['model_N_Nuc'],df['glm_N_Nuc'],(conc_dict['N_Nuc'])[1,3,:,:],(conc_dict_glm['N_Nuc'])[1,3,:,:],
...
if 'N_10' in varlist:
    ...
    plot_comparison(df,df['N_10'],df['model_N_10'],df['glm_N_10'],(conc_dict['N_10'])[1,3,:,:],(conc_dict_glm['N_10'])[1,3,:,:],
...
if 'N_All' in varlist:
    ...
    plot_comparison(df,df['N_All'],df['model_N_All'],df['glm_N_All'],(conc_dict['N_All'])[1,3,:,:],(conc_dict_glm['N_All'])[1,3,:,:],
...
if 'N_100' in varlist:                                                                                                                                               
    ...
    plot_comparison(df,df['N_100'],df['model_N_100'],df['glm_N_100'],(conc_dict['N_100'])[1,3,:,:],(conc_dict_glm['N_100'])[1,3,:,:],                                    
