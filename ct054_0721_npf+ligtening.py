...
path_model='/jet/home/ding0928/cylc-run/u-ct504/share/cycle/20140720T0000Z/Regn1/resn_1/RA2M/um/'
path_glm = '/jet/home/ding0928/cylc-run/u-ct504/share/cycle/20140720T0000Z/glm/um/'
...
if make_dataset==1:
    ...
    df.to_csv('interpolated_0721_lighenting_'+date+'.csv')
else:
    df = pd.read_csv('interpolated_0721_lighenting_'+date+'.csv',index_col=0, parse_dates=True)
    # print df.head()
    conc_dict = load_model(timeindexes_lam, path_model,varlist,date,1,0)
...
if 'NH3' in varlist:
    ...
    plot_comparison(df,df['NH3'],df['model_NH3'],df['glm_NH3'],(conc_dict['NH3'])[1,3,:,:],(conc_dict_glm['NH3'])[1,1,:,:],
                    'NH3 (ppbv)', 0.1,10,0.1,10,True,norm_array_nh3,'korus_nh3_'+date+'ion_npf_cs093.png', date)
    plot_vertical(df,conc_dict['NH3'].coord('level_height'),df['NH3'],df['model_NH3'],df['glm_NH3'],10, 'NH3 (pptv)','korus_nh3_vp_'+date+'ion_npf_cs093.png')
...
if 'C5H8' in varlist:
    ...
    plot_comparison(df,df['C5H8'],df['model_C5H8'],df['glm_C5H8'],(conc_dict['C5H8'])[1,3,:,:],(conc_dict_glm['C5H8'])[1,1,:,:],
                    'C5H8 (pptv)',1,600,0.01,1000.0,False,norm_array_c5h8,'korus_c5h8_'+date+'ion_npf_cs093.png', date)
    plot_vertical(df,conc_dict['C5H8'].coord('level_height'),df['C5H8'],df['model_C5H8'],df['glm_C5H8'],500, 'C5H8 (pptv)','korus_c5h8_vp_'+date+'ion_npf_cs093.png')
...
if 'NO' in varlist:
    ...
    plot_comparison(df,df['NO'],df['model_NO'],df['glm_NO'],(conc_dict['NO'])[1,3,:,:],(conc_dict_glm['NO'])[1,1,:,:],
                    'NO (pptv)', 5,5000,20,1000,True,norm_array_no,'korus_no_'+date+'ion_npf_cs093.png', date)
    plot_vertical(df,conc_dict['NO'].coord('level_height'),df['NO'],df['model_NO'],df['glm_NO'],5500, 'NO (pptv)','korus_no_vp_'+date+'ion_npf_cs093.png')
