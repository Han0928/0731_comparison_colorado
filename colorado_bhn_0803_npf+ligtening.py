...
from obser_for_Merge_0803_altagl import merge_obs_method
...
def read_flight_data(date):
    ...
    tracktime,alt,lat,lon = read_flight_track(flight_path,73, 4,2,3) # .checked 0803
    ...
    c5h8time, c5h8,nh3,dummy = read_flight_track(c5h8_path, 67, 17,3,1) #.checked 0803
...
if date=='20140803':
    timeindexes_glm=['009','012','015','018']  #0803+12h=0803_12pm
    timeindexes_lam=['012','018'] #0801+24h+12h=0802_12pm
    lonmin=-112
...
if make_dataset==1:
    ...
    df.to_csv('interpolated_0802_lighenting_'+date+'.csv')
else:
    df = pd.read_csv('interpolated_0802_lighenting_'+date+'.csv',index_col=0, parse_dates=True)
    # print df.head()
    conc_dict = load_model(timeindexes_lam, path_model,varlist,date,1,0)
