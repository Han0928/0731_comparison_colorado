...
# def colorado_mod_J():
date= '20140727'
varlist = ['SO2']#C5H8','C10H16','NO','NO2','O3','CO','CH4','NH3','P','T',
            #'N_Nuc','N_Ait','N_Acu','N_Ait_In','OH', 'H2SO4','SO2',
...
#print df.head()
if 'SO2' in varlist:
    norm_array_so2 = [20,50,100,200,500]
    plot_comparison(df,df['SO2'],df['model_SO2'],df['glm_SO2'],(conc_dict['SO2'])[1,3,:,:],(conc_dict_glm['SO2'])[1,1,:,:],
                    'SO$_{2}$ (pptv)',20,500,20,500,True,norm_array_so2,'130_so2_'+date+'_ion_npf_cs093.png', date)
    plot_vertical(df,conc_dict['SO2'].coord('level_height'),df['SO2'],df['model_SO2'],df['glm_SO2'],500, 'SO$_{2}$ (pptv)','130_so2'+date+'ion_npf_cs093.png')
...
if 'H2SO4' in varlist:
    norm_array_h2so4=[0.0001,0.02,0.05,0.1,0.2,0.3,0.5,0.8,1.0,1.5]
    plot_comparison(df,df['H2SO4'],df['model_H2SO4'],df['glm_H2SO4'],(conc_dict['H2SO4'])[1,3,:,:],(conc_dict_glm['H2SO4'])[1,1,:,:],
                    'H2SO4 (pptv)', 0.0001,1.5,0.0001,1.5,False,norm_array_h2so4,'130_h2so4_'+date+'ion_npf_cs093.png', date)
...
if 'O3' in varlist:
    ...
    plot_comparison(df,df['O3'],df['model_O3'],df['glm_O3'],(conc_dict['O3'])[1,3,:,:],(conc_dict_glm['O3'])[1,1,:,:],'O3 (ppbv)', 30,90,30,90,False,norm_array_o3,'130_O3_'+date+'ion_npf_cs093.png', date)
