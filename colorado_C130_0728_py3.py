...
from obser_for_Merge_0728_C130 import merge_obs_method
...
def load_model(timeindexes,path,varlist,date,is_lam,is_dump):
    ...
    if 'N_All'in varlist or 'N_Nuc'in varlist or 'N_Ait_In' in varlist or 'N_Ait' in varlist or 'N_Acu' in varlist or 'N_Cor' in varlist \
        ...
        # from now on, I will calculate the ratio of CCN(N100)/Nall
...
def read_flight_data(date):
    flight_path = '/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140728_R4.ict'
    ...
    h2so4_path = '/jet/home/ding0928/Colorado/Colorado/FRAPPE-OH-H2SO4_C130_20140728_R0.ict'
    ...
    nh3_path = '/jet/home/ding0928/Colorado/Colorado/FRAPPE-NH3_C130_20140728_R0.ict'
    nh3_time, nh3, dummy, dummy = read_flight_track(nh3_path, 37, 3, 3, 3)
    nh3track = interp_flight_data(tracktime, nh3_time, nh3, -99)  # ppbv!

    # so2 missing in 0731
    so2_path = '/jet/home/ding0928/Colorado/Colorado/FRAPPE-GTCIMS_C130_20140728_R1.ict'
    so2_time, so2, dummy, dummy = read_flight_track(so2_path, 37, 4, 4, 4)
    so2track = interp_flight_data(tracktime, so2_time, so2, -99)  #ppt

    no_o3_path = '/jet/home/ding0928/Colorado/Colorado/FRAPPE-NONO2O3_C130_20140728_R0.ict'
    ...
    date = '20140728'
    unix_epoch_of_28July2014_0001 = 1406505600
    if date == '20140728':
        trackpdtime = pd.to_datetime(np.asarray(tracktime) + unix_epoch_of_28July2014_0001, unit='s')
...
date= '20140728'
#varlist = ['NO','NO2','O3','CO','NH3','P','T','SO2','OH', 'H2SO4','SUMNC2']
varlist = ['NO','NO2','O3','CO','NH3','P','T','nuc_CCN','N_100','OH', 'H2SO4','SUMNC2']
# make_dataset=0
is_dump=0
if is_dump:
    varlist=['T']

path_model='/jet/home/ding0928/cylc-run/u-cs093/share/cycle/20140728T0000Z/Regn1/resn_1/RA2M/um/'
path_glm = '/jet/home/ding0928/cylc-run/u-cs093/share/cycle/20140728T0000Z/glm/um/'
...
if date=='20140728':
    timeindexes_glm=['015','018','021','024']  
    timeindexes_lam=['012','018','024'] 
    lonmin=-112
...
if make_dataset==1:
    ...
    df.to_csv('interpolated_0728_c130_'+date+'.csv')
else:
    df = pd.read_csv('interpolated_0728_c130_'+date+'.csv',index_col=0, parse_dates=True)
    #print(df.head())
    conc_dict = load_model(timeindexes_lam, path_model,varlist,date,1,0)
...
if 'NH3' in varlist:
    norm_array_nh3=[1,5,10,15,20,25,30,50,100,200,300]
