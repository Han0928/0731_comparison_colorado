...
from obser_for_Merge_0723_altagl import merge_obs_method
...
def read_flight_data(date):
    ...
    c5h8time, c5h8, c10h16, nh3 = read_flight_track(c5h8_path, 67, 17, 31, 3) #.checked 0723
    ...
    notime, no, no2, o3 = read_flight_track(no_o3_path, 47, 3, 5, 6) #checked 0723
...
if date=='20140723':
    timeindexes_glm=['033','036','039','042','045']  #0722+24h+12h=0729_12pm
    timeindexes_lam=['030','036','042'] #0722+24h+12h=0729_12pm
    lonmin=-112
...
if make_dataset==1:
    ...
    df.to_csv('interpolated_0723_lighenting_'+date+'.csv')
else:
    df = pd.read_csv('interpolated_0723_lighenting_'+date+'.csv',index_col=0, parse_dates=True)
    # print df.head()
    conc_dict = load_model(timeindexes_lam, path_model,varlist,date,1,0)
