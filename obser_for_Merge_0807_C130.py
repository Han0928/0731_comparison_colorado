...
def merge_obs_method():
    ...
    global sumnc_smps
    file_100 = Dataset(
        '/jet/home/ding0928/Colorado/EOLdata/dataaw2NKX/RF09Z.20140807.163300_212500.PNI.nc')  #
    print('file_100', file_100)
    temp = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140807_R4.ict', delimiter=',',
                      skiprows=133, usecols=29)  # inC
    pres = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140807_R4.ict', delimiter=',',
                      skiprows=133, usecols=62)  # in hpa
    print('temp.shape', temp.shape)  # 17520,
    print('pres.shape', pres.shape)  # 17520,
    ...
    time_NAV = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140807_R4.ict',
                          delimiter=',',
    ...
    print('data_100.shape', data_100.shape)  # # (17521, 1, 31)
    ...
    # 0807 smps is all zero for C130
    # c = range(20, 34)  # column in smpsc=15*1
    # data_smps = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/frappe-SMPS_C130_20140807_R0.ict', delimiter=',',
    #                        skiprows=66, usecols=c)  # from col 18-33
    # data_smps = ma.masked_where(data_smps < 0, data_smps)
    # smps_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/frappe-SMPS_C130_20140807_R0.ict', delimiter=',',
    #                        skiprows=66, usecols=0)
    # # smps_time = smps_time[:, np.newaxis]
    #
    # # print('data_smps', data_smps.shape)  #(274, 14)
    # print('smps_time_shape', smps_time.shape)  # ('smps_time_shape', (274,))
