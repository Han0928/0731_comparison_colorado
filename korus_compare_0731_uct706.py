...
def read_flight_data(date):
    ...
    n100path='/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-LAS_P3B_20140731_R0.ict'
    ...
    smps_path_p3b='/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_20140731_R0.ict'
...
if date=='20140731':
    timeindexes_glm=['039','042','045','048']  #0722+24h+12h=0723_12pm
    timeindexes_lam=['042','048'] #0722+24h+12h=0723_12pm
    lonmin=-112
    lonmax=-97        #
    latmin=35
    latmax=46
...
if make_dataset==1:
    ...
    df.to_csv(path+'0731_ct706_dataset_'+date+'.csv')
    df_smps.to_csv(path+'0731_ct706_smps_dataset_'+date+'.csv')
    
    sys.exit()
else:
    df = pd.read_csv(path+'0731_ct706_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    if two_models==1:
        df2 = pd.read_csv(path+'0731_ct706_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    else:
        df2=None
    # print df.head()
    if date=='20160510':
...
df_smps = pd.read_csv(path+'0731_ct706_smps_dataset_'+date+'.csv',index_col=0, parse_dates=True)
print(df_smps)
plt.figure()
...
plt.legend()
df_smps_1 = df_smps.between_time(start_time='19:00', end_time='19:10').mean()
plot_sizedistribution(df_smps_1,'ct706-731L_13:00-13:10.png')
df_smps_2 = df_smps.between_time(start_time='21:10', end_time='21:30').mean()
plot_sizedistribution(df_smps_2,'ct706-731L_15:10-15:30.png')
df_smps_3 = df_smps.between_time(start_time='20:40', end_time='20:50').mean()
plot_sizedistribution(df_smps_3,'ct706-731L_14:40-14:50.png')
df_smps_4 = df_smps.between_time(start_time='22:00', end_time='22:20').mean()
plot_sizedistribution(df_smps_4,'ct706-731L_16:00-16:20.png')
df_smps_5 = df_smps.between_time(start_time='22:50', end_time='23:00').mean()
plot_sizedistribution(df_smps_5,'ct706-731L_16:50-17:00.png')
df_smps_6 = df_smps.between_time(start_time='19:30', end_time='19:40').mean()
plot_sizedistribution(df_smps_6,'ct706-731H_13:30-13:40.png')
