...
if make_dataset==1:
    ...
    df.to_csv(path+'0803_093_dataset_'+date+'.csv')
    df_smps.to_csv(path+'0803_093_smps_dataset_'+date+'.csv')
    
    sys.exit()
else:
    df = pd.read_csv(path+'0803_093_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    if two_models==1:
        df2 = pd.read_csv(path+'0803_093_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    else:
        df2=None
    # print df.head()
    if date=='20160510':
...
df_smps = pd.read_csv(path+'0803_093_smps_dataset_'+date+'.csv',index_col=0, parse_dates=True)
print(df_smps)
plt.figure()
...
plot_sizedistribution(df_smps_1,'803-093-L_10:10-10:30.png')
df_smps_3 = df_smps.between_time(start_time='17:00', end_time='17:15').mean()
plot_sizedistribution(df_smps_3,'803-093-L_11:00-11:15.png')
df_smps_2 = df_smps.between_time(start_time='18:10', end_time='18:20').mean()
plot_sizedistribution(df_smps_2,'803-093-H_12:10-12:20.png')
