...
if make_dataset==1:
    ...
    df.to_csv(path+'0729_093_dataset_'+date+'.csv')
    df_smps.to_csv(path+'0729_093_smps_dataset_'+date+'.csv')
    
    sys.exit()
else:
    df = pd.read_csv(path+'0729_093_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    if two_models==1:
        df2 = pd.read_csv(path+'0729_093_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    else:
        df2=None
    # print df.head()
    if date=='20160510':
...
df_smps = pd.read_csv(path+'0729_093_smps_dataset_'+date+'.csv',index_col=0, parse_dates=True)
print(df_smps)
plt.figure()
...
plot_sizedistribution(df_smps_1,'093-729L_08:40-09:0.png')
df_smps_2 = df_smps.between_time(start_time='16:00', end_time='16:20').mean()
plot_sizedistribution(df_smps_2,'093-729L_10:00-10:20.png')
df_smps_3 = df_smps.between_time(start_time='17:45', end_time='18:00').mean()
plot_sizedistribution(df_smps_3,'093-729L_11:45-12:00.png')
df_smps_4 = df_smps.between_time(start_time='17:30', end_time='17:40').mean()
plot_sizedistribution(df_smps_4,'093-729H_11:30-11:40.png')
