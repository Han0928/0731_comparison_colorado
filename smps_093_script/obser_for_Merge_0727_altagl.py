...
def read_p3b_smps():
    p3b_smps_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_20140727_R0.ict',
    ...
    if date == '20140727':
        trackpdtime = pd.to_datetime(np.asarray(p3b_smps_time) + unix_epoch_of_27July2014_0001, unit='s')

    c = range(6, 35)  # SMPS data, dN/dlogDp,from 7-37
    p3b_data_smps = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_20140727_R0.ict',
    ...
    plt.yscale('log')
    plt.text(0, 0, 'b).p-3b')
    xmin = '2014-07-27 11:30:00'
    xmax = '2014-07-27 16:30:00'
    plt.xlim(xmin, xmax)


# new updated for p-3b
def merge_obs_method():
    time_NAV = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140727_r0.ict',
                          delimiter=',',
                          skiprows=73, usecols=0)
    temp = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140727_r0.ict', delimiter=',',
                      skiprows=73, usecols=18)  # inC
    pres = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140727_r0.ict', delimiter=',',
                      skiprows=73, usecols=24)  # in hpa
    # print('pres.shape', np.array(pres).shape)  # pres.shape', (17739,)
    # print('temp.shape', np.array(temp).shape)

    # load >100nm LAS data for acc+coar
    c = range(5, 31)
    data_las = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-LAS_P3B_20140727_R0.ict',
    ...
    las_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE'
                          '-LAS_P3B_20140727_R0.ict', delimiter=',', skiprows=69, usecols=0)
    ...
    data_smps = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_20140727_R0.ict',
                           delimiter=',', skiprows=72, usecols=c)  # from col 18-33
    data_smps = ma.masked_where(data_smps < 0, data_smps)

    smps_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_20140727_R0.ict',
                           delimiter=',', skiprows=72, usecols=0)
    ...
    alt_p3b = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140727_r0.ict',
                         delimiter=',',
    ...
    unix_epoch_of_27July2014_0001 = 1406419200
    if date == '20140727':
        trackpdtime = pd.to_datetime(np.asarray(time_NAV) + unix_epoch_of_27July2014_0001, unit='s')
    ...
    xmax = '2014-07-27 16:30:00'
    plt.xlim(xmin, xmax)
    print('mean:sumnc_smps', np.nanmean(sumnc_smps))
    print('mean:sumnc_smps', np.nanmean(np.where(sumnc_smps >= 0, sumnc_smps, np.nan)))
    return sumnc_smps


def aerosol_3_10nm():
    p3b_cNgtnm_smps_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE'
                                      '-CNC_P3B_20140727_R0.ict', delimiter=',', skiprows=47, usecols=0)
    ...
    p3b_data_CNgt3 = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE'
                                '-CNC_P3B_20140727_R0.ict', delimiter=',', skiprows=47, usecols=1)
    ...
    p3b_data_CNgt10 = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE'
                                 '-CNC_P3B_20140727_R0.ict', delimiter=',', skiprows=47, usecols=2)
    p3b_data_CNgt10 = ma.masked_where(p3b_data_CNgt10 < 0, p3b_data_CNgt10)

    date = '20140727'
    unix_epoch_of_27July2014_0001 = 1406419200
    if date == '20140727':
        trackpdtime = pd.to_datetime(np.asarray(p3b_cNgtnm_smps_time) + unix_epoch_of_27July2014_0001, unit='s')
    ...
    indexed = df_3_2.set_index(df_3_2['time'], append=True)
    df_2 = indexed.resample('30S', on='time').mean()
    df_2['N_3nm'].plot()
    df_2['N_10nm'].plot()
    df_2['N_3~10nm'].plot()
    plt.grid(linestyle='-')
...
def read_flight_data(date):
    global trackpdtime
    alt_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140727_r0.ict'
    ...
    flight_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-CNC_P3B_20140727_R0.ict'
    ...
    unix_epoch_of_27July2014_0001 = 1406419200
    if date == '20140727':
        trackpdtime = pd.to_datetime(np.asarray(alt_time) + unix_epoch_of_27July2014_0001, unit='s')
...
def read_bao_tower_smps():
    ...
    # bao_tower_smps_time = bao_tower_smps_time - 21600

    date = '20140727'
    unix_epoch_of_27July2014_0001 = 1406419200
    if date == '20140727':
        trackpdtime = pd.to_datetime(np.asarray(bao_tower_smps_time) + unix_epoch_of_27July2014_0001, unit='s')
...
def read_BAO21_precursor():
    ...
    BAO21_nh3_data = np.loadtxt(
        ...
        '-TOWER_20140727_R1.ict',
        delimiter=',', skiprows=63035, usecols=1, max_rows=18000)

    BAO21_nh3_data = ma.masked_where(BAO21_nh3_data < 0, BAO21_nh3_data)
    BAO21_nh3_time = np.loadtxt(
        '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/FRAPPE-QCTILDAS-NH3_GROUND-BAO'
        '-TOWER_20140727_R1.ict',
        delimiter=',', skiprows=63035, usecols=0, max_rows=18000)
    ...
    print('mask_nh3 ', mask_nh3)

    date = '20140727'
    unix_epoch_of_27July2014_0001 = 1406419200
    if date == '20140727':
        trackpdtime = pd.to_datetime(np.asarray(mask_nh3_time) + unix_epoch_of_27July2014_0001, unit='s')
    ...
    BAO21_so2_data = np.loadtxt(
        ...
        delimiter=',', skiprows=9182, usecols=2, max_rows=300)
    BAO21_so2_data = ma.masked_where(BAO21_so2_data < 0, BAO21_so2_data)
    BAO21_so2_time = np.loadtxt(
        '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/Frappe-SO2_GROUND-BAO-TOWER_20140721_R0.ict',
        delimiter=',', skiprows=9182, usecols=0, max_rows=300)
    ...
    # print('so2_gas_track', so2_gas_track)
    ...
    xmax = '2014-07-27 16:30:00'
    plt.xlim(xmin, xmax)
    # here makes no difference,since all masked out<0
    # print('mean:BAO21_nh3_data', np.nanmean(np.copy(mask_nh3)))
    print('mean:BAO21_nh3_data filter<0', np.nanmean(np.where(np.copy(mask_nh3) >= 0, np.copy(mask_nh3), np.nan)))
    # print('mean:BAO21_so2_data', np.nanmean(BAO21_so2_data))
    print('mean:BAO21_so2_data filter<0', np.nanmean(np.where(BAO21_so2_data >= 0, BAO21_so2_data, np.nan)))
...
def bao_tower_windrose():  # 11.5*60+47=737  16.5*60+47=1037
    ...
    bao_tower_time10 = np.loadtxt(
        '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/FRAPPE-TowerMet_GROUND'
        '-BAO-TOWER_20140727_RB.ict', delimiter=',', skiprows=1097, usecols=0, max_rows=300)
    ...
    print('bao_tower_wd10[-1]', bao_tower_wd10[-1])
    plt.show()
