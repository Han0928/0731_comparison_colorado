...
if make_dataset==1:
    ...
    df.to_csv(path+'0802_093_dataset_'+date+'.csv')
    df_smps.to_csv(path+'0802_093_smps_dataset_'+date+'.csv')
    
    sys.exit()
else:
    df = pd.read_csv(path+'0802_093_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    if two_models==1:
        df2 = pd.read_csv(path+'0802_093_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    else:
        df2=None
    # print df.head()
    if date=='20160510':
...
df_smps = pd.read_csv(path+'0802_093_smps_dataset_'+date+'.csv',index_col=0, parse_dates=True)
print(df_smps)
plt.figure()
...
plot_sizedistribution(df_smps_1,'802-093-L_11:00-11:20.png')
df_smps_3 = df_smps.between_time(start_time='17:55', end_time='18:05').mean()
plot_sizedistribution(df_smps_3,'802-093L_11:55-12:05.png')
df_smps_2 = df_smps.between_time(start_time='15:50', end_time='16:00').mean()
plot_sizedistribution(df_smps_2,'802-093H_09:50-10:00.png')
