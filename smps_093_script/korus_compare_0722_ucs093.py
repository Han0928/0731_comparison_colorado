...
def read_flight_data(date):
    ...
    n100path='/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-LAS_P3B_20140722_R0_L1.ict'
    ...
    smps_path_p3b='/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_20140722_R0_L1.ict'
    ...
    smpspdtime = pd.to_datetime(np.asarray(twod_smps['Mid_UTC'])+unix_epoch_of_22July2014_0001,unit='s')
...
if date=='20140722':
    timeindexes_glm=['012','015','018']  #0722+24h+12h=0723_12pm
...
if make_dataset==1:
    ...
    df.to_csv(path+'0722_093_dataset_'+date+'.csv')
    df_smps.to_csv(path+'0722_093_smps_dataset_'+date+'.csv')
    
    sys.exit()
else:
    df = pd.read_csv(path+'0722_093_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    if two_models==1:
        df2 = pd.read_csv(path+'0722_093_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    else:
        df2=None
    # print df.head()
    if date=='20160510':
...
df_smps = pd.read_csv(path+'0722_093_smps_dataset_'+date+'.csv',index_col=0, parse_dates=True)
print(df_smps)
plt.figure()
...
plt.legend()
df_smps_1 = df_smps.between_time(start_time='15:00', end_time='15:20').mean() #L
plot_sizedistribution(df_smps_1,'0722_093_L09:00-09:20.png')
df_smps_2 = df_smps.between_time(start_time='15:50', end_time='16:00').mean() #L
plot_sizedistribution(df_smps_2,'0722_093_L09:50-10:00.png')
df_smps_3 = df_smps.between_time(start_time='16:30', end_time='16:40').mean() #L
plot_sizedistribution(df_smps_3,'0722_093_L10:30-10:40.png')
df_smps_4 = df_smps.between_time(start_time='17:50', end_time='18:00').mean() #H
plot_sizedistribution(df_smps_4,'0722_093_H11:50-12:00.png')
