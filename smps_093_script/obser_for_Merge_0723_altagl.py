...
def read_p3b_smps():
    p3b_smps_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_20140723_R0_L1.ict',
                               delimiter=',', skiprows=72, usecols=0)
    c = range(6, 35)  # SMPS data, dN/dlogDp,from 7-37
    p3b_data_smps = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_20140723_R0_L1.ict',
    ...
    date = '20140723'
    unix_epoch_of_22July2014_0001 = 1406073600
    if date == '20140723':
    ...
    plt.yscale('log')
    plt.text(0, 0, 'b).p-3b')
    xmin = '2014-07-23 07:30:00'
    xmax = '2014-07-23 13:00:00'
    plt.xlim(xmin, xmax)


# new updated for p-3b
def merge_obs_method():
    time_NAV = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140723_r0_L1.ict',
                          delimiter=',',
                          skiprows=73, usecols=0)
    temp = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140723_r0_L1.ict',
                      delimiter=',',
                      skiprows=73, usecols=18)  # inC
    pres = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140723_r0_L1.ict',
                      delimiter=',',
                      skiprows=73, usecols=24)  # in hpa
    print('pres.shape', np.array(pres).shape)  #
    print('temp.shape', np.array(temp).shape)

    # load >100nm LAS data for acc+coar
    c = range(5, 31)
    data_las = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-LAS_P3B_20140723_R0_L1.ict',
                          delimiter=',', skiprows=69, usecols=c)
    data_las = ma.masked_where(data_las < 0, data_las)
    print('data_las.shape', data_las.shape)  # data_las.shape', (16597, 26))
    las_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-LAS_P3B_20140723_R0_L1.ict',
    ...
    data_smps = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_20140723_R0_L1.ict',
                           delimiter=',', skiprows=72, usecols=c)  # from col 18-33
    data_smps = ma.masked_where(data_smps < 0, data_smps)

    smps_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_20140723_R0_L1.ict',
                           delimiter=',', skiprows=72, usecols=0)
    ...
    alt_p3b = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140723_r0_L1.ict',
                         delimiter=',',
...
def aerosol_3_10nm():
    p3b_cNgtnm_smps_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE'
                                      '-CNC_P3B_20140723_R0_L1.ict', delimiter=',', skiprows=47, usecols=0)
    p3b_cNgtnm_smps_time = p3b_cNgtnm_smps_time - 21600

    p3b_data_CNgt3 = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-CNC_P3B_20140723_R0_L1.ict',
                                delimiter=',', skiprows=47, usecols=1)
    p3b_data_CNgt3 = ma.masked_where(p3b_data_CNgt3 < 0, p3b_data_CNgt3)

    p3b_data_CNgt10 = np.loadtxt(
        '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-CNC_P3B_20140723_R0_L1.ict', delimiter=',',
...
def read_flight_data(date):
    global trackpdtime
    alt_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140723_r0_L1.ict'
    ...
    flight_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-CNC_P3B_20140723_R0_L1.ict'
...
def read_bao_tower_smps():  # notice this is MDT!!
    bao_tower_smps_time = np.loadtxt('/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/frappe-ground'
                                     '-smps_GROUND-BAO-TOWER_20140723_R1.ict', delimiter=',', skiprows=88,
                                     usecols=0)

    c = range(28, 51)
    bao_tower_smps = np.loadtxt('/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/frappe-ground'
                                '-smps_GROUND-BAO-TOWER_20140723_R1.ict', delimiter=',', skiprows=88, usecols=c)
...
def read_BAO21_precursor():
    ...
    BAO21_nh3_data = np.loadtxt(
        ...
        delimiter=',', skiprows=48635, usecols=1, max_rows=19800)

    BAO21_nh3_data = ma.masked_where(BAO21_nh3_data < 0, BAO21_nh3_data)
    BAO21_nh3_time = np.loadtxt(
        '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/FRAPPE-QCTILDAS-NH3_GROUND-BAO'
        '-TOWER_20140723_R1.ict',
        delimiter=',', skiprows=48635, usecols=0, max_rows=19800)
    ...
    date = '20140723'
    unix_epoch_of_23July2014_0001 = 1406073600
    if date == '20140723':
        trackpdtime = pd.to_datetime(np.asarray(mask_nh3_time) + unix_epoch_of_23July2014_0001, unit='s')
    ...
    BAO21_so2_data = np.loadtxt(
        ...
        delimiter=',', skiprows=3183, usecols=2, max_rows=330)
    ...
    BAO21_so2_time = np.loadtxt(
        '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/Frappe-SO2_GROUND-BAO-TOWER_20140721_R0.ict',
        delimiter=',', skiprows=3183, usecols=0, max_rows=330)
...
#
# def ground_composition():
#     time_composition = np.loadtxt(
#         '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/FRAPPE-AML-Particle_GROUND-MOBILE_20140723_R0'
#         '.ict',
#         delimiter=',', skiprows=848, usecols=0, max_rows=330)
#     org_ground = np.loadtxt(
#         '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/FRAPPE-AML-Particle_GROUND-MOBILE_20140723_R0'
#         '.ict',
#         delimiter=',', skiprows=848, usecols=3, max_rows=330)
#     no3_ground = np.loadtxt(
#         '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/FRAPPE-AML-Particle_GROUND-MOBILE_20140723_R0'
#         '.ict',
#         delimiter=',', skiprows=848, usecols=4, max_rows=330)
#     so4_ground = np.loadtxt(
#         '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/FRAPPE-AML-Particle_GROUND-MOBILE_20140723_R0'
#         '.ict',
#         delimiter=',', skiprows=848, usecols=5, max_rows=330)
#     bc_ground = np.loadtxt(
#         '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/FRAPPE-AML-Particle_GROUND-MOBILE_20140723_R0'
#         '.ict',
#         delimiter=',', skiprows=848, usecols=6, max_rows=330)
#
#     time_composition = time_composition - 21600
#     date = '20140723'
#     unix_epoch_of_23July2014_0001 = 1406073600
#     if date == '20140723':
#         trackpdtime = pd.to_datetime(np.asarray(time_composition) + unix_epoch_of_23July2014_0001, unit='s')
#
#     ax1 = fig.add_subplot(gs[4, :])
#     d2 = {'time': pd.Series(trackpdtime), 'Org': pd.Series(np.asarray(org_ground)),
#           'NO3-': pd.Series(np.asarray(no3_ground)),
#           'SO4 2-': pd.Series(np.asarray(so4_ground)),
#           'BC': pd.Series(np.asarray(bc_ground))}
#     df_3 = pd.DataFrame(d2)
#
#     df_3_2 = df_3[['time', 'Org', 'NO3-', 'SO4 2-', 'BC']]
#     df_3_2 = df_3_2.set_index('time')
#     df_3_2.index = pd.to_datetime(df_3_2.index)
#
#     print('df_3_2', df_3_2.shape)
#     df_BC_filter = df_3_2[df_3_2['BC'] != -9999.000]
#     print('df_BC_filter', df_BC_filter.shape)
#     df_SO4_filter = df_BC_filter[df_BC_filter['SO4 2-'] != -9999.000]
#     print('df_SO4_filter', df_SO4_filter.shape)
#     df_NO3_filter = df_SO4_filter[df_SO4_filter['NO3-'] != -9999.000]
#     print('df_NO3_filter', df_NO3_filter.shape)
#     df_final_filter = df_NO3_filter[df_NO3_filter['Org'] != -9999.000]
#     print('df_final_filter', df_final_filter.shape)
#     print('df_final', df_final_filter)
#     # print('df_final_time', df_final_filter['time'])
#
#     # df.set_index('TYPE', append=True)['VOL'].unstack().plot.bar(stacked=True, figsize=(10, 8))
#
#     df_final_filter.plot( kind='bar', stacked=True)
#
...
#     # plt.show()
#
#     # df_final_filter[['Org', 'NO3-', 'SO4 2-', 'BC']].plot(kind='bar', stacked=True)
#     # plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
#     # #
#     # df_final_filter.plot(kind='bar', stacked=True, colormap='Spectral')
#     # indexed = df_final_filter.set_index(df_final_filter['time'], append=True)
#     # df_2 = indexed.resample('1T', on='time').mean()
#     # # df_2['BAO21_nh3'].plot(label="NH$_{3}$")
#     # df_2.plot.bar(x='time', stacked=True)
#     xmin = '2014-07-23 07:30:00'
#     xmax = '2014-07-23 13:00:00'
#     plt.xlim(xmin, xmax)
#     # indexed = df_3_2.set_index(df_3_2['time'], append=True)
...
def bao_tower_windrose():
    bao_tower_ws10 = np.loadtxt(
        '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/FRAPPE-TowerMet_GROUND-BAO-TOWER_20140723_RB.ict',
        delimiter=',', skiprows=857,
        usecols=3, max_rows=330)  # =
    bao_tower_wd10 = np.loadtxt(
        '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/FRAPPE-TowerMet_GROUND'
        '-BAO-TOWER_20140723_RB.ict', delimiter=',', skiprows=857,
        usecols=4, max_rows=330)  # =
    bao_tower_time10 = np.loadtxt(
        '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/FRAPPE-TowerMet_GROUND'
        '-BAO-TOWER_20140723_RB.ict', delimiter=',', skiprows=857, usecols=0, max_rows=330)
    ...
    print('bao_tower_wd10[-1]', bao_tower_wd10[-2])
    plt.show()
