...
def read_p3b_smps():
    p3b_smps_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_20140731_R0.ict',
                               delimiter=',', skiprows=72, usecols=0)
    c = range(6, 35)  # SMPS data, dN/dlogDp,from 7-37
    p3b_data_smps = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_20140731_R0.ict',
    ...
    if date == '20140731':
        trackpdtime = pd.to_datetime(np.asarray(p3b_smps_time) + unix_epoch_of_31July2014_0001, unit='s')
...
def merge_obs_method():
    ...
    for i in range(26):
        ...
        # gas_las_data3.append(np.divide(term3, term2)) #this is H suggested but give 2d results
    ...
    alt_p3b = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140731_r0.ict',
                         delimiter=',',
...
def aerosol_3_10nm():
    p3b_cNgtnm_smps_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-CNC_P3B_20140731_R0'
                                      '.ict', delimiter=',', skiprows=47, usecols=0)
    p3b_cNgtnm_smps_time = p3b_cNgtnm_smps_time - 21600

    p3b_data_CNgt3 = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-CNC_P3B_20140731_R0.ict',
                                delimiter=',', skiprows=47, usecols=1)
    p3b_data_CNgt3 = ma.masked_where(p3b_data_CNgt3 < 0, p3b_data_CNgt3)

    p3b_data_CNgt10 = np.loadtxt(
        '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-CNC_P3B_20140731_R0.ict', delimiter=',',
        skiprows=47, usecols=2)
    p3b_data_CNgt10 = ma.masked_where(p3b_data_CNgt10 < 0, p3b_data_CNgt10)

    date = '20140731'
    unix_epoch_of_31July2014_0001 = 1406764800
    if date == '20140731':
        trackpdtime = pd.to_datetime(np.asarray(p3b_cNgtnm_smps_time) + unix_epoch_of_31July2014_0001, unit='s')
...
def read_flight_data(date):
    global trackpdtime
    alt_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140731_r0.ict'
    ...
    flight_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-CNC_P3B_20140731_R0.ict'
    ...
    unix_epoch_of_31July2014_0001 = 1406764800
    if date == '20140731':
        trackpdtime = pd.to_datetime(np.asarray(alt_time) + unix_epoch_of_31July2014_0001, unit='s')
...
def read_ground0731_ict():
    smps_time = np.loadtxt('/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/DISCOVERAQ-LARGE_GROUND'
                           '-MOBILE_20140731_R0.ict', delimiter=',', skiprows=109, usecols=3)
    # smps_time = smps_time - 21600

    c = range(44, 56)  # SMPS data, dN/dlogDp,from 44-55
    data_smps = np.loadtxt('/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/DISCOVERAQ-LARGE_GROUND'
                           '-MOBILE_20140731_R0.ict', delimiter=',', skiprows=109, usecols=c)  # from col 44-55, 2_d
    data_smps = ma.masked_where(data_smps < 0, data_smps)

    date = '20140731'
    unix_epoch_of_31July2014_0001 = 1406764800
    if date == '20140731':
        trackpdtime = pd.to_datetime(np.asarray(smps_time) + unix_epoch_of_31July2014_0001, unit='s')

    # ax3 = fig.add_subplot(gs[0, :])
    plt.figure(constrained_layout=True,figsize=(20, 10))
    diam_list = np.array([10, 13, 18, 24, 32, 42, 56, 75, 100, 133, 178, 237])
    plt.pcolormesh(trackpdtime, diam_list, data_smps.T, norm=colors.LogNorm(vmin=10, vmax=110000),
                   cmap='RdBu_r')
    plt.colorbar(label='dN/dlog$_{Dp}$\n(# cm$^{-3}$)', extend='max')
    plt.ylabel('Diameter\n (nm)')
    plt.ylim(10, 300)
    ...
    xmin = '2014-07-31 10:00:00'
    xmax = '2014-07-31 18:00:00'
    plt.xlim(xmin, xmax)
    plt.xticks(rotation=30)
    plt.savefig("731_GROUND_latlon.jpg", dpi=1500)
    # plt.savefig("0731_GROUND-BAO-TOWER.pdf")
    # plt.savefig("0731_GROUND-BAO-TOWER.jpg", dpi=1500)
    # plt.savefig("0731_GROUND-BAO-TOWER.jpg", dpi=1500)
    # # plt.xticks(color='w')

def groundlatlon_ict():  # note the 3rd column is LT!!!
    lat = np.loadtxt('/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/DISCOVERAQ-LARGE_GROUND'
                     '-MOBILE_20140731_R0.ict', delimiter=',', skiprows=109, usecols=4)
    lon = np.loadtxt('/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/DISCOVERAQ-LARGE_GROUND'
                     '-MOBILE_20140731_R0.ict', delimiter=',', skiprows=109, usecols=5)
    time = np.loadtxt('/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/DISCOVERAQ-LARGE_GROUND'
                      '-MOBILE_20140731_R0.ict', delimiter=',', skiprows=109, usecols=3)
    date = '20140731'
    unix_epoch_of_31July2014_0001 = 1406764800
    if date == '20140731':
        trackpdtime = pd.to_datetime(np.asarray(time) + unix_epoch_of_31July2014_0001, unit='s')

    ax1 = fig.add_subplot(gs[1, :])
    d2 = {'time': pd.Series(trackpdtime), 'lat': pd.Series(np.asarray(lat)), 'lon': pd.Series(np.asarray(lon))}
    df_3 = pd.DataFrame(d2)
    df_3_2 = df_3[['time', 'lat', 'lon']]
    indexed = df_3_2.set_index(df_3_2['time'], append=True)
    df_2 = indexed.resample('1T', on='time').mean()
    df_2['lat'].plot(label="Lat")
    df_2['lon'].plot(label="Lon")
    plt.grid(linestyle='-')
    ...
    # xmax = '2014-07-31 17:30:00'
    # plt.xlim(xmin, xmax)
    plt.savefig("731_GROUND_latlon.jpg", dpi=1000)


def read_ground0801_ict():  # note the 3rd column is LT!!!
    smps_time = np.loadtxt('/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/DISCOVERAQ-LARGE_GROUND'
                           '-MOBILE_20140801_R0.ict', delimiter=',', skiprows=109, usecols=3)
    # smps_time = smps_time - 21600

    c = range(44, 56)  # SMPS data, dN/dlogDp,from 44-55
    data_smps = np.loadtxt('/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/DISCOVERAQ-LARGE_GROUND'
                           '-MOBILE_20140801_R0.ict', delimiter=',', skiprows=109, usecols=c)  # from col 44-55, 2_d
    data_smps = ma.masked_where(data_smps < 0, data_smps)

    date = '20140801'
    unix_epoch_of_1August2014_0001 = 1406851200
    if date == '20140801':
        trackpdtime = pd.to_datetime(np.asarray(smps_time) + unix_epoch_of_1August2014_0001, unit='s')
    ...
    plt.yscale('log')
    plt.text(0, 0, 'c).BAO Tower')
    # xmin = '2014-07-31 03:00:00'
    # xmax = '2014-07-31 17:30:00'
    # plt.xlim(xmin, xmax)
    plt.xticks(rotation=30)
    plt.savefig("0801_GROUND-BAO-TOWER.jpg", dpi=1000)
...
def read_BAO21_precursor():
    ...
    BAO21_nh3_data = np.loadtxt(
        ...
        '-TOWER_20140731_R1.ict',
        delimiter=',', skiprows=32434, usecols=1, max_rows=52200)
    BAO21_nh3_data = ma.masked_where(BAO21_nh3_data < -99, BAO21_nh3_data)
    BAO21_nh3_time = np.loadtxt(
        '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/FRAPPE-QCTILDAS-NH3_GROUND-BAO'
        '-TOWER_20140731_R1.ict',
        delimiter=',', skiprows=32434, usecols=0, max_rows=52200)
    BAO21_nh3_time = BAO21_nh3_time - 21600
    # print('BAO21_nh3_data', BAO21_nh3_data)
    ...
    unix_epoch_of_31July2014_0001 = 1406764800
    if date == '20140731':
        trackpdtime = pd.to_datetime(np.asarray(mask_nh3_time) + unix_epoch_of_31July2014_0001, unit='s')
    # print('trackpdtime_nh3', trackpdtime)
    ...
    BAO21_so2_data = np.loadtxt(
        ...
        delimiter=',', skiprows=14430, usecols=2, max_rows=870)
    BAO21_so2_data = ma.masked_where(BAO21_so2_data < -99, BAO21_so2_data)
    # print('BAO21_so2_data.shape', np.array(BAO21_so2_data).shape)  # 42781
    BAO21_so2_time = np.loadtxt(
        '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/Frappe-SO2_GROUND-BAO-TOWER_20140721_R0.ict',
        delimiter=',', skiprows=14430, usecols=0, max_rows=870)
    BAO21_so2_time = BAO21_so2_time - 21600  # to MT
    # print('LT:BAO21_so2_time', BAO21_so2_time)
    ...
    # print('BAO21_so2_data', BAO21_so2_data)
    ...
    # print('trackpdtime_so2', trackpdtime)
    ...
    print('mean:BAO21_nh3_data', np.nanmean(mask_nh3))
...
def bao_tower_windrose():
    bao_tower_wd10 = np.loadtxt(
        ...
        '-BAO-TOWER_20140731_RB.ict', delimiter=',', skiprows=587, usecols=4, max_rows=870)
    bao_tower_ws10 = np.loadtxt(
        '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/FRAPPE-TowerMet_GROUND-BAO-TOWER_20140731_RB.ict',
        delimiter=',', skiprows=587, usecols=3, max_rows=870)
    bao_tower_time10 = np.loadtxt(
        '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/FRAPPE-TowerMet_GROUND'
        '-BAO-TOWER_20140731_RB.ict', delimiter=',', skiprows=587, usecols=0, max_rows=330)
    # print('wd_time', (bao_tower_time10 - 21600) / 3600)
    ...
    print('bao_tower_wd10[300]', bao_tower_wd10[0])
    plt.savefig('/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/wr_0731.pdf')
    plt.show()
...
def cal_mean_Nnuc_below2500():
    ...
    print('df', df)
    newdf = df.mask(df["altitude"] > 2500)
