...
def read_p3b_smps():
    p3b_smps_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_20140810_R0_L1.ict',
                               delimiter=',', skiprows=72, usecols=0)
    c = range(6, 35)  # SMPS data, dN/dlogDp,from 7-37
    p3b_data_smps = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_20140810_R0_L1.ict',
    ...
    date = '20140810'
    unix_epoch_of_10August2014_0001 = 1407628800
    if date == '20140810':
        trackpdtime = pd.to_datetime(np.asarray(p3b_smps_time) + unix_epoch_of_10August2014_0001, unit='s')
    ...
    plt.yscale('log')
    plt.text(0, 0, 'b).p-3b')
    xmin = '2014-08-10 08:30:00'
    xmax = '2014-08-10 13:00:00'
    plt.xlim(xmin, xmax)
    # ax3.legend(loc='best')
...
def merge_obs_method():
    time_NAV = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140810_r0_L1.ict',
                          delimiter=',',
                          skiprows=73, usecols=0)
    temp = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140810_r0_L1.ict',
                      delimiter=',',
                      skiprows=73, usecols=18)  # inC
    pres = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140810_r0_L1.ict',
                      delimiter=',',
                      skiprows=73, usecols=24)  # in hpa

    # load >100nm LAS data for acc+coar
    c = range(5, 31)
    data_las = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-LAS_P3B_20140810_R0_L1.ict',
                          delimiter=',', skiprows=69, usecols=c)
    data_las = ma.masked_where(data_las < 0, data_las)
    las_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-LAS_P3B_20140810_R0_L1.ict',
    ...
    data_smps = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_20140810_R0_L1.ict',
                           delimiter=',', skiprows=72, usecols=c)  # from col 18-33
    data_smps = ma.masked_where(data_smps < 0, data_smps)

    smps_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_20140810_R0_L1.ict',
                           delimiter=',', skiprows=72, usecols=0)
    ...
    alt_p3b = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140810_r0_L1.ict',
                         delimiter=',',
    ...
    unix_epoch_of_10August2014_0001 = 1407628800
    if date == '20140810':
        trackpdtime = pd.to_datetime(np.asarray(time_NAV) + unix_epoch_of_10August2014_0001, unit='s')
...
def aerosol_3_10nm():
    p3b_cNgtnm_smps_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE'
                                      '-CNC_P3B_20140810_R0_L1.ict', delimiter=',', skiprows=47, usecols=0)
    p3b_cNgtnm_smps_time = p3b_cNgtnm_smps_time - 21600

    p3b_data_CNgt3 = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-CNC_P3B_20140810_R0_L1.ict',
                                delimiter=',', skiprows=47, usecols=1)
    p3b_data_CNgt3 = ma.masked_where(p3b_data_CNgt3 < 0, p3b_data_CNgt3)

    p3b_data_CNgt10 = np.loadtxt(
        '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-CNC_P3B_20140810_R0_L1.ict', delimiter=',',
    ...
    unix_epoch_of_10August2014_0001 = 1407628800
    if date == '20140810':
        trackpdtime = pd.to_datetime(np.asarray(p3b_cNgtnm_smps_time) + unix_epoch_of_10August2014_0001, unit='s')
...
def read_flight_data(date):
    global trackpdtime
    alt_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140810_r0_L1.ict'
    alt_time, lat, lon, alt = read_N3_10_below2500m(alt_path, 73, 2, 3, 4)

    flight_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-CNC_P3B_20140810_R0_L1.ict'
    ...
    unix_epoch_of_10August2014_0001 = 1407628800
    if date == '20140810':
        trackpdtime = pd.to_datetime(np.asarray(alt_time) + unix_epoch_of_10August2014_0001, unit='s')
...
def read_bao_tower_smps():  # notice this is MDT!!
    bao_tower_smps_time = np.loadtxt('/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/frappe-ground'
                                     '-smps_GROUND-BAO-TOWER_20140810_R1.ict', delimiter=',', skiprows=88,
                                     usecols=0)

    c = range(28, 51)
    bao_tower_smps = np.loadtxt('/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/frappe-ground'
                                '-smps_GROUND-BAO-TOWER_20140810_R1.ict', delimiter=',', skiprows=88, usecols=c)
    ...
    unix_epoch_of_10August2014_0001 = 1407628800
    if date == '20140810':
        trackpdtime = pd.to_datetime(np.asarray(bao_tower_smps_time) + unix_epoch_of_10August2014_0001, unit='s')
...
def read_BAO21_precursor():
    ...
    BAO21_nh3_data = np.loadtxt(
        ...
        '-TOWER_20140810_R1.ict',
        delimiter=',', skiprows=52233, usecols=1, max_rows=16200)
    BAO21_nh3_data = ma.masked_where(BAO21_nh3_data < -99, BAO21_nh3_data)
    BAO21_nh3_time = np.loadtxt(
        '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/FRAPPE-QCTILDAS-NH3_GROUND-BAO'
        '-TOWER_20140810_R1.ict',
        delimiter=',', skiprows=52233, usecols=0, max_rows=16200)
    ...
    unix_epoch_of_10August2014_0001 = 1407628800
    if date == '20140810':
        trackpdtime = pd.to_datetime(np.asarray(mask_nh3_time) + unix_epoch_of_10August2014_0001, unit='s')
    ...
    BAO21_so2_data = np.loadtxt(
        ...
        delimiter=',', skiprows=28647, usecols=2, max_rows=270)  # 24815=LT 0807 8AM
    ...
    BAO21_so2_time = np.loadtxt(
        '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/Frappe-SO2_GROUND-BAO-TOWER_20140721_R0.ict',
        delimiter=',', skiprows=28647, usecols=0, max_rows=270)
...
def bao_tower_windrose():
    bao_tower_ws10 = np.loadtxt(
        '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/FRAPPE-TowerMet_GROUND-BAO-TOWER_20140810_RB.ict',
        delimiter=',', skiprows=917,
        usecols=3, max_rows=270)
    bao_tower_wd10 = np.loadtxt(
        '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/FRAPPE-TowerMet_GROUND-BAO-TOWER_20140810_RB.ict',
        delimiter=',', skiprows=917,
        usecols=4, max_rows=270)  # =
    bao_tower_time10 = np.loadtxt(
        '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/FRAPPE-TowerMet_GROUND-BAO-TOWER_20140810_RB.ict',
        delimiter=',', skiprows=917, usecols=0, max_rows=270)
    ...
    print('bao_tower_wd10[270]', bao_tower_wd10[-1])  # 246.58
    plt.show()
