...
path_model='/jet/home/ding0928/cylc-run/u-cs093/share/cycle/20140805T0000Z/Regn1/resn_1/RA2M/um/'
path_glm = '/jet/home/ding0928/cylc-run/u-cs093/share/cycle/20140805T0000Z/glm/um/'
...
if 'H2SO4' in varlist:
    ...
    plot_comparison(df,df['H2SO4'],df['model_H2SO4'],df['glm_H2SO4'],(conc_dict['H2SO4'])[1,3,:,:],(conc_dict_glm['H2SO4'])[1,1,:,:],
                    'H2SO4 (pptv)', 0.0001,1.5,0.0001,1.5,True,norm_array_h2so4,'130_h2so4_'+date+'ion_npf_cs093.png', date)
