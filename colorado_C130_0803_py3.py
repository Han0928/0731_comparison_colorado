...
from obser_for_Merge_0803_C130 import merge_obs_method
...
def load_um_cube(timeindexes,surfcoord, inputfile,cubename, is_lam):
    ...
    # print('cube_in_load_um_cube', cube)
    return cube
...
def read_flight_data(date):
    flight_path = '/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140803_R4.ict'
    ...
    h2so4_path = '/jet/home/ding0928/Colorado/Colorado/FRAPPE-OH-H2SO4_C130_20140803_R0.ict'
    ...
    nh3_path = '/jet/home/ding0928/Colorado/Colorado/FRAPPE-NH3_C130_20140803_R0.ict'
    nh3_time, nh3, dummy, dummy = read_flight_track(nh3_path, 37, 3, 3, 3)
    nh3track = interp_flight_data(tracktime, nh3_time, nh3, -99)  # ppbv!

    so2_path = '/jet/home/ding0928/Colorado/Colorado/FRAPPE-GTCIMS_C130_20140803_R2.ict'
    so2_time, so2, dummy, dummy = read_flight_track(so2_path, 37, 4, 4, 4)
    so2track = interp_flight_data(tracktime, so2_time, so2, -99)  #ppt

    # no_o3_path = '/jet/home/ding0928/Colorado/Colorado/FFRAPPE-NONO2O3_C130_20140803_R0.ict'
    ...
    date = '20140803'
    unix_epoch_of_3August2014_0001 = 1407024000
    if date == '20140803':
        trackpdtime = pd.to_datetime(np.asarray(tracktime) + unix_epoch_of_3August2014_0001, unit='s')
...
date= '20140803'
varlist = ['NO2','CO','NH3','P','T','SO2','nuc_CCN','N_100',
            'OH', 'H2SO4','SUMNC2']
# make_dataset=0
is_dump=0
if is_dump:
...
path_model='/jet/home/ding0928/cylc-run/u-ct706/share/cycle/20140803T0000Z/Regn1/resn_1/RA2M/um/'
path_glm = '/jet/home/ding0928/cylc-run/u-ct706/share/cycle/20140803T0000Z/glm/um/'
...
if date=='20140803':
    timeindexes_glm=['018','021','024','027']  #0801+24h+12h=0802_12pm
    timeindexes_lam=['018','024'] #0801+24h+12h=0802_12pm
    lonmin=-112
...
if make_dataset==1:
    ...
    df.to_csv('interpolated_0803_c130_'+date+'.csv')
else:
    df = pd.read_csv('interpolated_0803_c130_'+date+'.csv',index_col=0, parse_dates=True)
    print(df.head())
    conc_dict = load_model(timeindexes_lam, path_model,varlist,date,1,0)
...
#print('H_so2_level_height',conc_dict['SO2'].coord('level_height').points)
#print('H_so2_level_height',conc_dict['SO2'].coord('level_height'))
...
if 'NH3' in varlist:
    norm_array_nh3=[1,5,10,15,20,25,30,50,100,150]
    ...
    plot_vertical(df,conc_dict['NH3'].coord('level_height'),df['NH3'],df['model_NH3'],df['glm_NH3'],40, 'NH3 (ppbv)','130_nh3'+date+'ion_npf_cs093.png')
