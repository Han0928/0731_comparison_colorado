...
if make_dataset==1:
    ...
    df.to_csv(path+'0731_093_dataset_'+date+'.csv')
    df_smps.to_csv(path+'0731_093_smps_dataset_'+date+'.csv')
    
    sys.exit()
else:
    df = pd.read_csv(path+'0731_093_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    if two_models==1:
        df2 = pd.read_csv(path+'0731_093_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    else:
        df2=None
    # print df.head()
    if date=='20160510':
...
df_smps = pd.read_csv(path+'0731_093_smps_dataset_'+date+'.csv',index_col=0, parse_dates=True)
print(df_smps)
plt.figure()
...
plot_sizedistribution(df_smps_1,'093-731L_13:00-13:10.png')
df_smps_2 = df_smps.between_time(start_time='21:10', end_time='21:30').mean()
plot_sizedistribution(df_smps_2,'093-731L_15:10-15:30.png')
df_smps_3 = df_smps.between_time(start_time='20:40', end_time='20:50').mean()
plot_sizedistribution(df_smps_3,'093-731L_14:40-14:50.png')
df_smps_4 = df_smps.between_time(start_time='22:00', end_time='22:20').mean()
plot_sizedistribution(df_smps_4,'093-731L_16:00-16:20.png')
