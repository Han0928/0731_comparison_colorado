...
def plot_comparison(df,col_label,lam2d,glm2d,ylabel,var_min,var_max,map_min,map_max,is_log,norm_array,saving_name,date,two_models,df2,plot_obs=1):
    ...
    plt.tight_layout()
    plt.savefig('/jet/home/ding0928/box_model/data/overall_code/rerun_NH3_emission/neutralization/ground_obs_npf/0721_comparison/'+saving_name)
...
def read_flight_data(date):
    flight_path='/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140721_r0.ict'
    ...
    c5h8_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-PTRTOF-NMHCs_P3B_20140721_R0.ict'
    ...
    no_o3_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-NOXYO3_P3B_20140721_R0.ict'
    ...
    co_p3b_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-DACOM_P3B_20140721_R1_L1.ict'
    ...
    n_nuc_p3b_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-CNC_P3B_20140721_R0.ict'
    ...
    n100path='/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-LAS_P3B_20140721_R0.ict'
    ...
    smps_path_p3b='/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_20140721_R0.ict'
    ...
    if date == '20140721':
        trackpdtime = pd.to_datetime(np.asarray(tracktime) + unix_epoch_of_21July2014_0001, unit='s')

    smpspdtime = pd.to_datetime(np.asarray(twod_smps['Mid_UTC'])+unix_epoch_of_21July2014_0001,unit='s')
...
path_model='/jet/home/ding0928/cylc-run/u-cs093/share/cycle/20140720T0000Z/Regn1/resn_1/RA2M/um/'
path_glm = '/jet/home/ding0928/cylc-run/u-cs093/share/cycle/20140720T0000Z/glm/um/'
...
if date=='20140721':
    timeindexes_glm=['036','039','042']  #0720+24h+12h=0721_12pm
    timeindexes_lam=['036','042'] #0720+24h+12h=0721_12pm
    lonmin=-112
...
if make_dataset==1:
    ...
    df.to_csv(path+'interpolated_093_dataset_'+date+'.csv')
    df_smps.to_csv(path+'interpolated_093_smps_dataset_'+date+'.csv')
    
    sys.exit()
else:
    df = pd.read_csv(path+'interpolated_093_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    if two_models==1:
        df2 = pd.read_csv(path+'interpolated_093_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    else:
        df2=None
    # print df.head()
    if date=='20160510':
...
df_smps = pd.read_csv(path+'interpolated_093_smps_dataset_'+date+'.csv',index_col=0, parse_dates=True)
print(df_smps)
plt.figure()
...
plt.legend()
df_smps_1 = df_smps.between_time(start_time='14:50', end_time='15:00').mean() #L
plot_sizedistribution(df_smps_1,'0721_093_L08:50-09:0.png')
df_smps_2 = df_smps.between_time(start_time='17:00', end_time='17:30').mean() #L
plot_sizedistribution(df_smps_2,'0721_093_L11:00-11:30.png')
df_smps_3 = df_smps.between_time(start_time='17:50', end_time='18:10').mean() #L
plot_sizedistribution(df_smps_3,'0721_093_L11:50-12:10.png')
df_smps_4 = df_smps.between_time(start_time='16:50', end_time='17:00').mean() #H
plot_sizedistribution(df_smps_4,'0721_093_H10:50-11:00.png')
# df_smps_5 = df_smps.between_time(start_time='22:50', end_time='23:00').mean()
# plot_sizedistribution(df_smps_5,'0721_093_16:50-17:00.png')
# df_smps_6 = df_smps.between_time(start_time='19:30', end_time='19:40').mean() #why this time priod?
# plot_sizedistribution(df_smps_6,'0721_093_13:30-13:40.png')
