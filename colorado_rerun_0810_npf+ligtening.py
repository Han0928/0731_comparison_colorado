...
from obser_for_Merge_0810_altagl import merge_obs_method
...
def read_flight_data(date):
    flight_path='/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140810_r0_L1.ict'

    tracktime,alt,lat,lon = read_flight_track(flight_path,73, 4,2,3) # .checked 0810
    ...
    c5h8_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-PTRTOF-NMHCs_P3B_20140810_R0_L1.ict'
    c5h8time, c5h8,nh3,dummy = read_flight_track(c5h8_path, 67, 17,3,1) #.checked 0810
    c5h8track = interp_flight_data(tracktime, c5h8time, c5h8, -99) #ppbv
    nh3track = interp_flight_data(tracktime, c5h8time, nh3, -99) #ppbv

    no_o3_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-NOXYO3_P3B_20140810_R0_L1.ict'
    notime, no, no2, o3 = read_flight_track(no_o3_path, 47, 3, 5, 6) #checked 0810
    ...
    co_p3b_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-DACOM_P3B_20140810_R1_L1.ict'
    ...
    n_nuc_p3b_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-CNC_P3B_20140810_R0_L1.ict'
    ...
    if date == '20140810':
        trackpdtime = pd.to_datetime(np.asarray(tracktime) + unix_epoch_of_10August2014_0001, unit='s')
...
path_model='/jet/home/ding0928/cylc-run/u-cs093/share/cycle/20140809T0000Z/Regn1/resn_1/RA2M/um/'
path_glm = '/jet/home/ding0928/cylc-run/u-cs093/share/cycle/20140809T0000Z/glm/um/'
...
if date=='20140810':
    timeindexes_glm=['036','039','042','045']  #0809+36h=0810_12pm
    timeindexes_lam=['036','042','048'] #0809+36h=0810_12pm
    lonmin=-112
...
if make_dataset==1:
    ...
    df.to_csv('interpolated_0810_lighenting_'+date+'.csv')
else:
    df = pd.read_csv('interpolated_0810_lighenting_'+date+'.csv',index_col=0, parse_dates=True)
    # print df.head()
    conc_dict = load_model(timeindexes_lam, path_model,varlist,date,1,0)
