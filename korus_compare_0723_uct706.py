...
def read_flight_data(date):
    flight_path='/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140723_r0_L1.ict'
    ...
    c5h8_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-PTRTOF-NMHCs_P3B_20140723_R0_L1.ict'
    ...
    no_o3_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-NOXYO3_P3B_20140723_R0_L1.ict'
    ...
    co_p3b_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-DACOM_P3B_20140723_R1_L2.ict'
    ...
    n_nuc_p3b_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-CNC_P3B_20140723_R0_L1.ict'
    ...
    n100path='/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-LAS_P3B_20140723_R0_L1.ict'
    ...
    smps_path_p3b='/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_20140723_R0_L1.ict'
    ...
    if date == '20140723':
        trackpdtime = pd.to_datetime(np.asarray(tracktime) + unix_epoch_of_23July2014_0001, unit='s')

    smpspdtime = pd.to_datetime(np.asarray(twod_smps['Mid_UTC'])+unix_epoch_of_23July2014_0001,unit='s')
...
path_model='/jet/home/ding0928/cylc-run/u-ct706/share/cycle/20140722T0000Z/Regn1/resn_1/RA2M/um/'
path_glm = '/jet/home/ding0928/cylc-run/u-ct706/share/cycle/20140722T0000Z/glm/um/'
...
if date=='20140723':
    timeindexes_glm=['033','036','039','042','045']  #0722+24h+12h=0723_12pm
    timeindexes_lam=['030','036','042'] #0722+24h+12h=0723_12pm
    lonmin=-112
    lonmax=-97        #
    latmin=35
    latmax=46
...
if make_dataset==1:
    ...
    df.to_csv(path+'0723_076_dataset_'+date+'.csv')
    df_smps.to_csv(path+'0723_076_smps_dataset_'+date+'.csv')
    
    sys.exit()
else:
    df = pd.read_csv(path+'0723_076_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    if two_models==1:
        df2 = pd.read_csv(path+'0723_076_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    else:
        df2=None
    # print df.head()
    if date=='20160510':
...
df_smps = pd.read_csv(path+'0723_076_smps_dataset_'+date+'.csv',index_col=0, parse_dates=True)
print(df_smps)
plt.figure()
...
plt.legend()
df_smps_1 = df_smps.between_time(start_time='14:40', end_time='15:00').mean() #L
plot_sizedistribution(df_smps_1,'0723_076_L08:40-09:0.png')
df_smps_2 = df_smps.between_time(start_time='16:00', end_time='16:10').mean() #L
plot_sizedistribution(df_smps_2,'0723_076_L10:00-10:10.png')
df_smps_3 = df_smps.between_time(start_time='16:50', end_time='17:00').mean() #L
plot_sizedistribution(df_smps_3,'0723_076_L10:50-11:00.png')
...
# plot_sizedistribution(df_smps_5,'168_16:50-17:00.png')
# df_smps_6 = df_smps.between_time(start_time='19:30', end_time='19:40').mean() #why this time priod?
# plot_sizedistribution(df_smps_6,'168_13:30-13:40.png')
