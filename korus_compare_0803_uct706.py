...
def read_flight_data(date):
    flight_path='/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140803_r0_L1.ict'
    ...
    c5h8_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-PTRTOF-NMHCs_P3B_20140803_R0_L1.ict'
    ...
    no_o3_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-NOXYO3_P3B_20140803_R0_L1.ict'
    ...
    co_p3b_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-DACOM_P3B_20140803_R1_L1.ict'
    ...
    n_nuc_p3b_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-CNC_P3B_20140803_R0_L1.ict'
    ...
    n100path='/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-LAS_P3B_20140803_R0_L1.ict'
    ...
    smps_path_p3b='/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_20140803_R0_L1.ict'
    ...
    smpspdtime = pd.to_datetime(np.asarray(twod_smps['Mid_UTC'])+unix_epoch_of_3August2014_0001,unit='s')
    ...
    d = {'time': pd.Series(trackpdtime), 'latitude': pd.Series(np.asarray(lat)),
         ...
         'N_10': pd.Series(np.asarray(n10track)),
         'N_Nuc': pd.Series(nnuctrack), 'NO': pd.Series(notrack),
...
if date=='20140803':
    timeindexes_glm=['009','012','015','018']  #0722+24h+12h=0723_12pm
    timeindexes_lam=['012','018'] #0722+24h+12h=0723_12pm
    lonmin=-112
    lonmax=-97        #
    latmin=35
    latmax=46
...
if make_dataset==1:
    ...
    df.to_csv(path+'0803_ct706_dataset_'+date+'.csv')
    df_smps.to_csv(path+'0803_ct706_smps_dataset_'+date+'.csv')
    
    sys.exit()
else:
    df = pd.read_csv(path+'0803_ct706_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    if two_models==1:
        df2 = pd.read_csv(path+'0803_ct706_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    else:
        df2=None
    # print df.head()
    if date=='20160510':
...
df_smps = pd.read_csv(path+'0803_ct706_smps_dataset_'+date+'.csv',index_col=0, parse_dates=True)
print(df_smps)
plt.figure()
...
plt.legend()
df_smps_1 = df_smps.between_time(start_time='16:10', end_time='16:30').mean()
plot_sizedistribution(df_smps_1,'803-ct706-L_10:10-10:30.png')
df_smps_3 = df_smps.between_time(start_time='17:00', end_time='17:15').mean()
plot_sizedistribution(df_smps_3,'803-ct706-L_11:00-11:15.png')
df_smps_2 = df_smps.between_time(start_time='18:10', end_time='18:20').mean()
plot_sizedistribution(df_smps_2,'803-ct706-H_12:10-12:20.png')
