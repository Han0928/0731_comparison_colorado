...
if 'N_Nuc' in varlist:
    ...
    plot_comparison(df,df['N_Nuc'],df['model_N_Nuc'],df['glm_N_Nuc'],(conc_dict['N_Nuc'])[1,3,:,:],(conc_dict_glm['N_Nuc'])[1,1,:,:],
                    'N$_{nuc(3-10nm)}$\n(#cm$^{-3}$)', 100,1e4,100,1e4,True,norm_array_nuc,'korus_nnuc_'+date+'_bt116.pdf', date)
...
if 'N_All' in varlist:
    norm_array_all = [500,1000,1500,2500,3800,5000,8000,10000,12000,15000,18000,20000,25000,30000,35000]
    plot_comparison(df,df['N_All'],df['model_N_All'],df['glm_N_All'],(conc_dict['N_All'])[1,3,:,:],(conc_dict_glm['N_All'])[1,1,:,:],
                    'N$_{all(>3nm)}$\n(#cm$^{-3}$)', 500,3.5e4,500,3.5e4,True,norm_array_all,'korus_nall'+date+'_bt116.png', date)
