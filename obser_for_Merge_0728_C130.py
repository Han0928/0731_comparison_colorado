...
def merge_obs_method():
    ...
    file_100 = Dataset(
        '/jet/home/ding0928/Colorado/EOLdata/dataaw2NKX/RF03Z.20140728.163100_205100.PNI.nc')
    print('file_100', file_100)
    temp = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140728_R4.ict', delimiter=',',
                      skiprows=133, usecols=29)  # inC
    pres = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140728_R4.ict', delimiter=',',
                      skiprows=133, usecols=62)  # in hpa
    print('temp.shape', temp.shape)  # 15600
    print('pres.shape', pres.shape)  # 15600
    ...
    time_NAV = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140728_R4.ict',
                          delimiter=',',
    ...
    data_100 = (file_100.variables['CS200_RPI'][:, 0, :])  # (15601, 31)
    ...
    data_smps = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/frappe-SMPS_C130_20140728_R0.ict', delimiter=',',
                           skiprows=66, usecols=c)  # from col 18-33
    data_smps = ma.masked_where(data_smps < 0, data_smps)
    smps_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/frappe-SMPS_C130_20140728_R0.ict', delimiter=',',
                           skiprows=66, usecols=0)  # time resolution is different from uhsas, (246,)
    # smps_time = smps_time[:, np.newaxis]

    # print('data_smps', data_smps)  #(246, 14)
    print('smps_time_shape', smps_time.shape)  #(246,)
