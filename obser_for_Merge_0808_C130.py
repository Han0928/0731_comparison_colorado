...
def merge_obs_method():
    ...
    global sumnc_smps
    file_100 = Dataset(
        '/jet/home/ding0928/Colorado/EOLdata/dataaw2NKX/RF10Z.20140808.145300_182800.PNI.nc')  #
    print('file_100', file_100)
    temp = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140808_R4.ict', delimiter=',',
                      skiprows=133, usecols=29)  # inC
    pres = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140808_R4.ict', delimiter=',',
                      skiprows=133, usecols=62)  # in hpa
    print('temp.shape', temp.shape)  # 12900
    print('pres.shape', pres.shape)  # 12900,
    ...
    time_NAV = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140808_R4.ict',
                          delimiter=',',
    ...
    print('data_100.shape', data_100.shape)  # (12901, 31)
    ...
    # data_smps = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/frappe-SMPS_C130_20140808_R0.ict', delimiter=',',
    #                        skiprows=66, usecols=c)  # from col 18-33
    # data_smps = ma.masked_where(data_smps < 0, data_smps)
    # smps_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/frappe-SMPS_C130_20140808_R0.ict', delimiter=',',
    #                        skiprows=66, usecols=0)
    # # smps_time = smps_time[:, np.newaxis]
    # 
    # # print('data_smps', data_smps.shape)  #(204, 14)
    # print('smps_time_shape', smps_time.shape)  # (204)
