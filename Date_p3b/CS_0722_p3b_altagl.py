...
# for the long python script, only the subroutine merge_obs_method is called. Ignore other subroutine
def merge_obs_method(date):
    time_NAV = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_' + date + '_r0_L1.ict',
                          delimiter=',', skiprows=73, usecols=0)
    temp = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_' + date + '_r0_L1.ict',
                      delimiter=',', skiprows=73, usecols=18)  # inC
    pres = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_' + date + '_r0_L1.ict',
                      delimiter=',', skiprows=73, usecols=24)  # in hpa

    # load >100nm LAS data for acc+coar
    c = range(5, 31)
    data_las = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-LAS_P3B_' + date + '_R0_L1.ict',
                          delimiter=',', skiprows=69, usecols=c)
    data_las = ma.masked_where(data_las < 0, data_las)
    las_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-LAS_P3B_' + date + '_R0_L1.ict',
    ...
    data_smps = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_' + date + '_R0_L1.ict',
                           delimiter=',', skiprows=72, usecols=c)  # from col 18-33
    data_smps = ma.masked_where(data_smps < 0, data_smps)

    smps_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_' + date + '_R0_L1.ict',
    ...
    alt_p3b = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_' + date + '_r0_L1.ict',
                         delimiter=',',
...
def aerosol_3_10nm(date):
    ...
    p3b_data_CNgt3 = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE'
                                '-CNC_P3B_' + date + '_R0_L1.ict', delimiter=',', skiprows=47, usecols=1)
    ...
    p3b_data_CNgt10 = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE'
                                 '-CNC_P3B_' + date + '_R0_L1.ict', delimiter=',', skiprows=47, usecols=2)
...
def read_flight_data(date):
    alt_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_' + date + '_r0_L1.ict'
    ...
    flight_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-CNC_P3B_' + date + '_R0_L1.ict'
    ...
    obe_sumnc = merge_obs_method(date)
...
def bao_tower_windrose(date):
    bao_tower_ws10 = np.loadtxt(
        '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/FRAPPE-TowerMet_GROUND-BAO-TOWER_' + date + '_RB.ict',
    ...
    bao_tower_wd10 = np.loadtxt(
        ...
        '-BAO-TOWER_' + date + '_RB.ict', delimiter=',', skiprows=887,
        usecols=4, max_rows=300)  # =
    bao_tower_time10 = np.loadtxt(
        '/jet/home/ding0928/box_model/data/overall_code/ground_ob_data/FRAPPE-TowerMet_GROUND'
        '-BAO-TOWER_' + date + '_RB.ict', delimiter=',', skiprows=887, usecols=0, max_rows=300)
...
def cal_mean_Nnuc_below2500(date):
    date = '20140722'
...
date = '20140722'
merge_obs_method(date)
aerosol_3_10nm(date)
read_bao_tower_smps(date)
read_BAO21_precursor(date)
bao_tower_windrose(date)
cal_mean_Nnuc_below2500(date)
