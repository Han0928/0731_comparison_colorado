...
def merge_obs_method():
    ...
    file_100 = Dataset(
        '/jet/home/ding0928/Colorado/EOLdata/dataaw2NKX/RF06Z.20140802.205900_014900.PNI.nc')  # (16381, 31)
    print('file_100', file_100)
    temp = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140802_R4.ict', delimiter=',',
                      skiprows=133, usecols=29)  # inC
    pres = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140802_R4.ict', delimiter=',',
                      skiprows=133, usecols=62)  # in hpa  
    print('temp.shape', temp.shape)  # 17400
    print('pres.shape', pres.shape)  # 17400
    ...
    time_NAV = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140802_R4.ict',
                          delimiter=',',
                          skiprows=133, usecols=0)

    temp = np.concatenate((temp, [0]))  # to go from 17400 to 17401
    ...
    print('data_100.shape', data_100.shape)  # (17401, 31)
    ...
    data_smps = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/frappe-SMPS_C130_20140802_R0.ict', delimiter=',',
                           skiprows=66, usecols=c)  # from col 18-33
    data_smps = ma.masked_where(data_smps < 0, data_smps)
    smps_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/frappe-SMPS_C130_20140802_R0.ict', delimiter=',',
                           skiprows=66, usecols=0)  # time resolution is different from uhsas,(202,1)

    # print('data_smps', data_smps)
    print('data_smps_shape', data_smps.shape)  # (272, 14)
    ...
    for i in range(14):
        ...
        data_smps_new2 = data_smps_new[~data_smps_new.mask]  
    ...
    plt.ylim(0, 0.1)
    plt.title('0802_test_sum smps+sumnc')
