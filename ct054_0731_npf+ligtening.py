...
from obser_for_Merge_0731_altagl import merge_obs_method
...
path_model='/jet/home/ding0928/cylc-run/u-ct504/share/cycle/20140730T0000Z/Regn1/resn_1/RA2M/um/'
path_glm = '/jet/home/ding0928/cylc-run/u-ct504/share/cycle/20140730T0000Z/glm/um/'
...
if date=='20140731':
    timeindexes_glm=['039','042','045','048']  #0730+24h+18h=0731_18pm
...
if make_dataset==1:
    ...
    df.to_csv('interpolated_0731_lighenting_'+date+'.csv')
else:
    df = pd.read_csv('interpolated_0731_lighenting_'+date+'.csv',index_col=0, parse_dates=True)
    # print df.head()
    conc_dict = load_model(timeindexes_lam, path_model,varlist,date,1,0)
