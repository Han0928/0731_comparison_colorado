...
from obser_for_Merge_0802_C130 import merge_obs_method
...
def read_flight_data(date):
    flight_path = '/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140802_R4.ict'
    ...
    h2so4_path = '/jet/home/ding0928/Colorado/Colorado/FRAPPE-OH-H2SO4_C130_20140802_R0.ict'
    ...
    nh3_path = '/jet/home/ding0928/Colorado/Colorado/FRAPPE-NH3_C130_20140802_R0.ict'
    nh3_time, nh3, dummy, dummy = read_flight_track(nh3_path, 37, 3, 3, 3)
    nh3track = interp_flight_data(tracktime, nh3_time, nh3, -99)  # ppbv!

    so2_path = '/jet/home/ding0928/Colorado/Colorado/FRAPPE-GTCIMS_C130_20140802_R2.ict'
    so2_time, so2, dummy, dummy = read_flight_track(so2_path, 37, 4, 4, 4)
    so2track = interp_flight_data(tracktime, so2_time, so2, -99)  #ppt

    no_o3_path = '/jet/home/ding0928/Colorado/Colorado/FRAPPE-NONO2O3_C130_20140802_R0.ict'
    ...
    date = '20140802'
    unix_epoch_of_2August2014_0001 = 1406937600
    if date == '20140802':
        trackpdtime = pd.to_datetime(np.asarray(tracktime) + unix_epoch_of_2August2014_0001, unit='s')
...
path_model='/jet/home/ding0928/cylc-run/u-ct706/share/cycle/20140801T0000Z/Regn1/resn_1/RA2M/um/'
path_glm = '/jet/home/ding0928/cylc-run/u-ct706/share/cycle/20140801T0000Z/glm/um/'
...
if date=='20140802':
    timeindexes_glm=['042','045','048','051']  #0801+24h+18h=0802_12pm
    timeindexes_lam=['042','048'] #0801+24h+18h=0802_12pm
    lonmin=-112
...
if make_dataset==1:
    ...
    df.to_csv('interpolated_0802_c130_'+date+'.csv')
else:
    df = pd.read_csv('interpolated_0802_c130_'+date+'.csv',index_col=0, parse_dates=True)
    #print(df.head())
    conc_dict = load_model(timeindexes_lam, path_model,varlist,date,1,0)
