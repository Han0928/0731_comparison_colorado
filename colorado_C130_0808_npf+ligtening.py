...
from obser_for_Merge_0808_C130 import merge_obs_method
...
def read_flight_data(date):
    flight_path = '/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140808_R4.ict'
    ...
    h2so4_path = '/jet/home/ding0928/Colorado/Colorado/FRAPPE-OH-H2SO4_C130_20140808_R0.ict'
    ...
    nh3_path = '/jet/home/ding0928/Colorado/Colorado/FRAPPE-NH3_C130_20140808_R0.ict'
    nh3_time, nh3, dummy, dummy = read_flight_track(nh3_path, 37, 3, 3, 3)
    nh3track = interp_flight_data(tracktime, nh3_time, nh3, -99)  # ppbv!

    so2_path = '/jet/home/ding0928/Colorado/Colorado/FRAPPE-GTCIMS_C130_20140808_R1.ict'
    ...
    no_o3_path = '/jet/home/ding0928/Colorado/Colorado/FRAPPE-NONO2O3_C130_20140808_R0.ict'
    ...
    date = '20140808'
    unix_epoch_of_8August2014_0001 = 1407456000
    if date == '20140808':
        trackpdtime = pd.to_datetime(np.asarray(tracktime) + unix_epoch_of_8August2014_0001, unit='s')
...
if date=='20140808':
    timeindexes_glm=['036','039','042','045']  #0807+36h=0808_12pm
    timeindexes_lam=['036','042','048'] #0805+36h=0806_12pm
    lonmin=-112
...
if make_dataset==1:
    ...
    df.to_csv('interpolated_0808_c130_'+date+'.csv')
else:
    df = pd.read_csv('interpolated_0808_c130_'+date+'.csv',index_col=0, parse_dates=True)
    # print df.head()
    conc_dict = load_model(timeindexes_lam, path_model,varlist,date,1,0)
