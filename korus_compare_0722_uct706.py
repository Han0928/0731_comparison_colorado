...
if make_dataset==1:
    ...
    df.to_csv(path+'0722_076_dataset_'+date+'.csv')
    df_smps.to_csv(path+'0722_076_smps_dataset_'+date+'.csv')
    
    sys.exit()
else:
    df = pd.read_csv(path+'0722_076_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    if two_models==1:
        df2 = pd.read_csv(path+'0722_076_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    else:
        df2=None
    # print df.head()
    if date=='20160510':
...
df_smps = pd.read_csv(path+'0722_076_smps_dataset_'+date+'.csv',index_col=0, parse_dates=True)
print(df_smps)
plt.figure()
...
plot_sizedistribution(df_smps_1,'0722_076_L09:00-09:20.png')
df_smps_2 = df_smps.between_time(start_time='15:50', end_time='16:00').mean() #L
plot_sizedistribution(df_smps_2,'0722_076_L09:50-10:00.png')
df_smps_3 = df_smps.between_time(start_time='16:30', end_time='16:40').mean() #L
plot_sizedistribution(df_smps_3,'0722_076_L10:30-10:40.png')
df_smps_4 = df_smps.between_time(start_time='17:50', end_time='18:00').mean() #H
plot_sizedistribution(df_smps_4,'0722_076_H11:50-12:00.png')
