...
def load_model(timeindexes,path,varlist,date,is_lam,is_dump):
    ...
    if 'N_Ait_In' in varlist or 'N_Ait' in varlist or 'N_Acu' in varlist or 'N_Cor' in varlist \
            or 'D_Ait' in varlist or 'D_Acu' in varlist or 'D_Cor' in varlist or 'D_Ait_In' in varlist:
        numlabel='_pb'
        if is_lam:
            numlabel='_pe'
...
def read_flight_data(date):
    ...
    d= {'time':pd.Series(trackpdtime), 'latitude':pd.Series(np.asarray(lat)),'longitude':pd.Series(np.asarray(lon)),
        'altitude':pd.Series(np.asarray(alt_asl)),'altitude_agl':pd.Series(np.asarray(alt_agltrack)),
        'OH':pd.Series(ohtrack),'H2SO4':pd.Series(h2so4track),'C5H8':pd.Series(c5h8track),'NO':pd.Series(notrack),
        'O3':pd.Series(o3track), 'NH3':pd.Series(nh3track),'SO2':pd.Series(so2track), 'T':pd.Series(temptrack),'CO':pd.Series(cotrack),'P':pd.Series(pres2track),'SUMNC2':pd.Series(obe_sumnc)}
    # d= {'time':pd.Series(trackpdtime), 'latitude':pd.Series(np.asarray(lat)),'longitude':pd.Series(np.asarray(lon)),
...
varlist = ['OH', 'H2SO4','C5H8','NO','O3','NO3_Ait','NH4_Ait','SO4_Ait',
           'SO4_2','NO3','NH4','C10H16','NH3','SO2','T','CO','N_Ait','N_Acu','N_Cor','N_Ait_In','D_Ait','D_Acu','D_Cor','D_Ait_In', 'P','SUMNC2']
# varlist = []
# make_dataset=0
is_dump=0
if is_dump:
...
#path_model='/jet/home/ding0928/cylc-run/u-cd385/share/cycle/20140729T0000Z/Regn1/resn_1/RA1M/um/'
# path_model='/jet/home/earhg/cylc-run/u-cf279/share/cycle/20140801T0000Z/Regn1/resn_1/RA2M/um/'

path_model='/jet/home/ding0928/cylc-run/u-cd385/share/cycle/20140729T0000Z/Regn1/resn_1/RA1M/um/'
# new rose suite re: /jet/home/ding0928/cylc-run/u-cj832/share/cycle/20140729T0000Z/Regn1/resn_1/RA2M/um
# path_glm = '/ocean/projects/atm200005p/ding0928/cylc-run/u-cc346/share/cycle/20140729T0000Z/glm/um/'
# path_glm = '/jet/home/earhg/cylc-run/u-cf279/share/cycle/20140801T0000Z/glm/um/'
path_glm = '/jet/home/ding0928/cylc-run/u-cd385/share/cycle/20140729T0000Z/glm/um/'
