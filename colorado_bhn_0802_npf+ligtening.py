...
from obser_for_Merge_0802_altagl import merge_obs_method
...
def read_flight_data(date):
    ...
    tracktime,alt,lat,lon = read_flight_track(flight_path,73, 4,2,3) # .checked 0802
    ...
    c5h8time, c5h8,nh3,dummy = read_flight_track(c5h8_path, 67, 17,3,1) #.checked 0802
    ...
    notime, no, no2, o3 = read_flight_track(no_o3_path, 47, 3, 5, 6) #checked 0802
...
if date=='20140802':
    timeindexes_glm=['036','039','042']  #0801+24h+12h=0802_12pm
    timeindexes_lam=['036','042'] #0801+24h+12h=0802_12pm
    lonmin=-112
