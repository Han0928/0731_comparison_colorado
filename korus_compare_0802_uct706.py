...
def read_flight_data(date):
    flight_path='/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-reveal_p3b_20140802_r0_L1.ict'
    ...
    # c5h8_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/discoveraq-PTRTOF-NMHCs_P3B_20140802_R0_L1.ict'
    ...
    no_o3_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-NOXYO3_P3B_20140802_R0_L1.ict'
    ...
    co_p3b_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-DACOM_P3B_20140802_R1_L1.ict'
    ...
    n_nuc_p3b_path = '/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-CNC_P3B_20140802_R0_L1.ict'
    ...
    n100path='/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-LAS_P3B_20140802_R0_L1.ict'
    ...
    smps_path_p3b='/jet/home/ding0928/Colorado/Colorado/p-3b/DISCOVERAQ-LARGE-SMPS_P3B_20140802_R0_L1.ict'
    ...
    smpspdtime = pd.to_datetime(np.asarray(twod_smps['Mid_UTC'])+unix_epoch_of_2August2014_0001,unit='s')
...
if make_dataset==1:
    ...
    df.to_csv(path+'0802_ct076_dataset_'+date+'.csv')
    df_smps.to_csv(path+'0802_ct076_smps_dataset_'+date+'.csv')
    
    sys.exit()
else:
    df = pd.read_csv(path+'0802_ct076_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    if two_models==1:
        df2 = pd.read_csv(path+'0802_ct076_dataset_'+date+'.csv',index_col=0, parse_dates=True)
    else:
        df2=None
    # print df.head()
    if date=='20160510':
...
df_smps = pd.read_csv(path+'0802_ct076_smps_dataset_'+date+'.csv',index_col=0, parse_dates=True)
print(df_smps)
plt.figure()
...
plt.legend()
df_smps_1 = df_smps.between_time(start_time='17:00', end_time='17:20').mean()
plot_sizedistribution(df_smps_1,'802-ct076-L_11:00-11:20.png')
df_smps_3 = df_smps.between_time(start_time='17:55', end_time='18:05').mean()
plot_sizedistribution(df_smps_3,'802-ct076L_11:55-12:05.png')
df_smps_2 = df_smps.between_time(start_time='15:50', end_time='16:00').mean()
plot_sizedistribution(df_smps_2,'802-ct076_H_09:50-10:00.png')
