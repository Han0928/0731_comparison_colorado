...
def merge_obs_method():
    ...
    global sumnc_smps
    file_100 = Dataset(
        '/jet/home/ding0928/Colorado/EOLdata/dataaw2NKX/RF08Z.20140806.161100_201400.PNI.nc')  #
    print('file_100', file_100)
    temp = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140806_R4.ict', delimiter=',',
                      skiprows=133, usecols=29)  # inC
    pres = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140806_R4.ict', delimiter=',',
                      skiprows=133, usecols=62)  # in hpa
    print('temp.shape', temp.shape)  # 14580,
    print('pres.shape', pres.shape)  # 14580,
    ...
    time_NAV = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/FRAPPE-NCAR-LRT-NAV_C130_20140806_R4.ict',
                          delimiter=',',
    ...
    print('data_100.shape', data_100.shape)  # (14581, 31)
    ...
    data_smps = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/frappe-SMPS_C130_20140806_R0.ict', delimiter=',',
                           skiprows=66, usecols=c)  # from col 18-33
    data_smps = ma.masked_where(data_smps < 0, data_smps)
    smps_time = np.loadtxt('/jet/home/ding0928/Colorado/Colorado/frappe-SMPS_C130_20140806_R0.ict', delimiter=',',
                           skiprows=66, usecols=0)  # time resolution is different from uhsas,(202,1)
    # smps_time = smps_time[:, np.newaxis]

    # print('data_smps', data_smps.shape)  #(226, 14)
    print('smps_time_shape', smps_time.shape)  # 226
