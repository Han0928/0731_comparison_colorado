...
path_model='/jet/home/ding0928/cylc-run/u-ct706/share/cycle/20140720T0000Z/Regn1/resn_1/RA2M/um/'
path_glm = '/jet/home/ding0928/cylc-run/u-ct706/share/cycle/20140720T0000Z/glm/um/'
...
if make_dataset==1:
    ...
    df.to_csv('interpolated_0721_ct706_'+date+'.csv')
else:
    df = pd.read_csv('interpolated_0721_ct706_'+date+'.csv',index_col=0, parse_dates=True)
    # print df.head()
    conc_dict = load_model(timeindexes_lam, path_model,varlist,date,1,0)
...
if 'NH3' in varlist:
    norm_array_nh3=[0.01,0.15,0.2,0.5,1.2,1,3,5,10,20]
    plot_comparison(df,df['NH3'],df['model_NH3'],df['glm_NH3'],(conc_dict['NH3'])[1,3,:,:],(conc_dict_glm['NH3'])[1,1,:,:],
                    'NH3 (ppbv)', 0.1,4,0.1,4,True,norm_array_nh3,'korus_nh3_'+date+'ion_npf_cs093.png', date)
